"""
Django settings for vintage_drums project.
...
# SECRET_KEY = 'django-insecure-$mfk(h!-388ghco(s4fqv0u!f3zsr0h2mxe0$!gi6kp$r3s%=&'
# SECURITY WARNING: keep the secret key used in production secret!
...
ROOT_URLCONF = 'vintage_drums.urls'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'vintage-drum-store-1'
...
if 'DEVELOPEMENT' is os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'info@vintagedrums.com'
else:
